...
SECRET_KEY = 'django-insecure-*1z3_!jfi=xyeg1&bwpn%k^r2a5=xq8ra$1_g-(ty6i00=cju-'
...
DATABASES = {
    "default": django_mongodb_backend.parse_uri("mongodb://localhost:51395/cookbook?directConnection=true"),
}
